...
var Portal = (props) => {
  ...
  if (isServer || disabled) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children });
  const doc = getRootNode?.().ownerDocument ?? document;
  const mountNode = container?.current ?? doc.body;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: import_react.Children.map(children, (child) => (0, import_react_dom.createPortal)(child, mountNode)) });
};
...
var targetCache = (0, import_store.makeGlobal)("__zag__targetCache", () => /* @__PURE__ */ new WeakMap());
function useSnapshot(service, options) {
  ...
  const currSnapshot = (0, import_react3.useSyncExternalStore)(
    (0, import_react3.useCallback)((callback) => (0, import_store.subscribe)(service.state, callback, notifyInSync), [notifyInSync]),
    () => {
  ...
  const ctx = (0, import_react3.useMemo)(() => compact(context ?? {}), [context]);
  useUpdateEffect(() => {
