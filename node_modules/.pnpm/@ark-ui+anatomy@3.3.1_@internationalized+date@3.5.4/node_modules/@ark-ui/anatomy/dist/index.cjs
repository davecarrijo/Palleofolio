...
const index$2 = require('./color-picker/index.cjs');
...
const index$4 = require('./segment-group/index.cjs');
const index$5 = require('./select/index.cjs');
...
exports.checkboxAnatomy = index$1.anatomy;
...
exports.colorPickerAnatomy = index$2.anatomy;
Object.defineProperty(exports, "comboboxAnatomy", {
	enumerable: true,
	get: () => combobox.anatomy
});
exports.datePickerAnatomy = index$3.anatomy;
...
exports.segmentGroupAnatomy = index$4.anatomy;
exports.selectAnatomy = index$5.anatomy;
