...
var dom = (0, import_dom_query.createScope)({
  ...
  getNextTriggerEl: (ctx, id) => (0, import_dom_query.nextById)(dom.getTriggers(ctx), dom.getItemTriggerId(ctx, id)),
  getPrevTriggerEl: (ctx, id) => (0, import_dom_query.prevById)(dom.getTriggers(ctx), dom.getItemTriggerId(ctx, id))
});
