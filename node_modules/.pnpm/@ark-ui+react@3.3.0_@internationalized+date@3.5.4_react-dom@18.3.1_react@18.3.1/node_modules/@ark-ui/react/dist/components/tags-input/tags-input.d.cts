...
export { TagsInputItemDeleteTrigger as ItemDeleteTrigger, type TagsInputItemDeleteTriggerProps as ItemDeleteTriggerProps, } from './tags-input-item-delete-trigger';
export { TagsInputItemInput as ItemInput, type TagsInputItemInputProps as ItemInputProps, } from './tags-input-item-input';
export { TagsInputItemPreview as ItemPreview, type TagsInputItemPreviewProps as ItemPreviewProps, } from './tags-input-item-preview';
export { TagsInputItemText as ItemText, type TagsInputItemTextProps as ItemTextProps, } from './tags-input-item-text';
...
export { TagsInputRootProvider as RootProvider, type TagsInputRootProviderProps as RootProviderProps, } from './tags-input-root-provider';
