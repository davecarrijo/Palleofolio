...
export { RatingGroupControl as Control, type RatingGroupControlProps as ControlProps, } from './rating-group-control';
export { RatingGroupItem as Item, type RatingGroupItemProps as ItemProps, } from './rating-group-item';
