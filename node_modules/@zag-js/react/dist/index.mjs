...
// src/use-snapshot.ts
import { snapshot, subscribe, makeGlobal } from "@zag-js/store";
...
import ReactExport, { useCallback, useEffect as useEffect2, useMemo, useRef as useRef2, useSyncExternalStore } from "react";
...
var useSafeLayoutEffect = typeof document !== "undefined" ? useLayoutEffect : useEffect3;
