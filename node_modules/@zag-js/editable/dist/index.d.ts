...
declare const props: ("invalid" | "form" | "value" | "dir" | "id" | "getRootNode" | "name" | "disabled" | "placeholder" | "maxLength" | "onFocusOutside" | "onPointerDownOutside" | "onInteractOutside" | "ids" | "autoResize" | "activationMode" | "submitMode" | "startWithEditView" | "selectOnFocus" | "readOnly" | "onValueChange" | "onValueRevert" | "onValueCommit" | "onEdit" | "translations" | "finalFocusEl")[];
...
export { type ActivationMode, type MachineApi as Api, type UserDefinedContext as Context, type ElementIds, type IntlTranslations, type SubmitMode, type ValueChangeDetails, anatomy, connect, machine, props, splitProps };
