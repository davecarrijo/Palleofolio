...
var dom = (0, import_dom_query.createScope)({
  ...
  getNextEl: (ctx, loop) => (0, import_dom_query.nextById)(dom.getElements(ctx), ctx.highlightedValue, loop ?? ctx.loopFocus),
  getPrevEl: (ctx, loop) => (0, import_dom_query.prevById)(dom.getElements(ctx), ctx.highlightedValue, loop ?? ctx.loopFocus),
  getElemByKey: (ctx, key) => (0, import_dom_query.getByTypeahead)(dom.getElements(ctx), { state: ctx.typeaheadState, key, activeId: ctx.highlightedValue }),
  isTargetDisabled: (v) => {
...
function connect(state, send, normalize) {
  ...
  function getItemProps(props2) {
    ...
    return normalize.element({
      ...
      onPointerUp(event) {
        ...
        if (event.pointerType === "touch") (0, import_dom_event.clickIfLink)(target);
      },
      onTouchEnd(event) {
  ...
  return {
    ...
    getTriggerItemProps(childApi) {
      return (0, import_core.mergeProps)(
    ...
    getTriggerProps() {
      return normalize.button({
        ...
        onPointerDown(event) {
          const disabled = dom.isTargetDisabled(event.currentTarget);
          if (!(0, import_dom_event.isLeftClick)(event) || disabled || (0, import_dom_event.isContextMenuEvent)(event)) return;
          event.preventDefault();
          if (!dom.isTriggerItem(event.currentTarget)) {
            send({ type: "TRIGGER_CLICK", target: event.currentTarget });
          }
      ...
      return normalize.element({
        ...
        onKeyDown(event) {
          ...
          const keyMap = {
            ...
            Enter() {
              send("ENTER");
              (0, import_dom_event.clickIfLink)(item);
            },
            Space(event2) {
              if (isTypingAhead) {
          ...
          if (!(0, import_dom_event.isPrintableKey)(event)) return;
    ...
    getOptionItemProps(props2) {
      ...
      return {
        ...
        ...normalize.element({
          ...
          onPointerUp(event) {
            if (!(0, import_dom_event.isLeftClick)(event) || disabled) return;
            if ((0, import_dom_query2.isDownloadingEvent)(event)) return;
            if ((0, import_dom_query2.isOpeningInNewTab)(event)) return;
            const target = event.currentTarget;
  ...
  return (0, import_core2.createMachine)(
    ...
    },
    {
      ...
      guards: {
        ...
        isHighlightedItemEditable: (ctx2) => (0, import_dom_query3.isEditableElement)(dom.getHighlightedItemEl(ctx2)),
      ...
      activities: {
        ...
        scrollToHighlightedItem(ctx2, _evt, { getState }) {
          const exec = () => {
            ...
            (0, import_dom_query3.scrollIntoView)(itemEl, { rootEl: contentEl2, block: "nearest" });
          };
      ...
      actions: {
        ...
        focusMenu(ctx2) {
          (0, import_dom_query3.raf)(() => {
            const contentEl = dom.getContentEl(ctx2);
            const initialFocusEl = (0, import_dom_query3.getInitialFocus)({
              root: contentEl,
              enabled: !(0, import_dom_query3.contains)(contentEl, dom.getActiveElement(ctx2)),
              filter(node) {
...
var set = {
  highlighted(ctx, value) {
    if ((0, import_utils2.isEqual)(ctx.highlightedValue, value)) return;
...
var splitItemGroupLabelProps = (0, import_utils3.createSplitProps)(itemGroupLabelProps);
var itemGroupProps = (0, import_types.createProps)()(["id"]);
var splitItemGroupProps = (0, import_utils3.createSplitProps)(itemGroupProps);
...
var splitOptionItemProps = (0, import_utils3.createSplitProps)(optionItemProps);
